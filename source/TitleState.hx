...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var bg:FlxSprite = new FlxSprite().makeGraphic(FlxG.width, FlxG.height, 0xFF100D1E);
		// bg.antialiasing = ClientPrefs.globalAntialiasing;
		// bg.setGraphicSize(Std.int(bg.width * 0.6));
		// bg.updateHitbox();
		add(bg);

		logoBl = new FlxSprite(540, 45);
		...
		swagShader = new ColorSwap();
		gfDance = new FlxSprite(FlxG.width * 0.02, FlxG.height * 0.06);
		...
		titleText = new FlxSprite(200, FlxG.height * 0.81);
